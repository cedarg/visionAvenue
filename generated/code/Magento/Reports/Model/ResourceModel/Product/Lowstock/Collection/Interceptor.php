...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Product\Lowstock\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinInventoryItem');
        if (!$pluginInfo) {
            return parent::joinInventoryItem($fields);
        } else {
            return $this->___callPlugins('joinInventoryItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByProductType');
        if (!$pluginInfo) {
            return parent::filterByProductType($typeFilter);
        } else {
            return $this->___callPlugins('filterByProductType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByIsQtyProductTypes');
        if (!$pluginInfo) {
            return parent::filterByIsQtyProductTypes();
        } else {
            return $this->___callPlugins('filterByIsQtyProductTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useManageStockFilter');
        if (!$pluginInfo) {
            return parent::useManageStockFilter($storeId);
        } else {
            return $this->___callPlugins('useManageStockFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useNotifyStockQtyFilter');
        if (!$pluginInfo) {
            return parent::useNotifyStockQtyFilter($storeId);
        } else {
            return $this->___callPlugins('useNotifyStockQtyFilter', func_get_args(), $pluginInfo);
        }
    }
